    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_tax_amt', models.DecimalField(decimal_places=2, default=0, max_digits=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(default=None, max_length=24, null=True)),
                ('description', models.CharField(default=None, max_length=128, null=True)),
                ('abbreviation', models.CharField(default=None, max_length=3, null=True)),
                ('zipcode', models.CharField(default=None, max_length=10, null=True)),
                ('city', models.CharField(default=None, max_length=24, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.DecimalField(decimal_places=2, default=None, max_digits=12, null=True)),
                ('item_price', models.DecimalField(decimal_places=2, default=None, max_digits=12, null=True)),
                ('item_total_price', models.DecimalField(decimal_places=2, max_digits=12, null=True)),
                ('item_tax_amt', models.DecimalField(decimal_places=2, default=0, max_digits=12, null=True)),
                ...
                ('item_tax_rates', models.ManyToManyField(default=None, related_name='item_taxes', to='timelyapp.Taxes')),
            ],
        ),
        migrations.AddField(
            model_name='invoice',
